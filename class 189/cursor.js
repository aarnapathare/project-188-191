AFRAME.registerComponent("cursor-listener", {
    ...
    handleViewState:function(){
        ...
        const informationContainer = document.querySelector("information-container")
        const {selectedItemId} = informationContainer.getAttribute("cursos-listener")
        ...
        if(sideViewInfoId.includes(id)){
            ...
            skyEl.setAttribute("material", {
                src:`./assets/adolescents360.jpeg/${selectedItemId}/{id}.jpeg`, 
                color:"#fff"
            })
        }
    }, 
    ...
    handleInfoState: function(){
        ...
        if (infoId.includes(id)){
            const informationContainer = document.querySelector("#information-container")
            informationContainer.setAttribute("cursos-listener", {
                selectedItemId:id
            })
